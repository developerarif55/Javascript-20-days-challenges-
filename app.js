...
// our task should be execute

// 1 fist of all  give a message to user how much point i get so message div
// 2 we need a game area to display the circle
// 3 we need to show the results as well
// 4 also we need buttons to play
